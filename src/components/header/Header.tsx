...
import { addUser } from "@/src/store/nextSlice";
 ...
 return (
    <div className="w-full h-20 bg-amazon_blue text-lightText sticky top-0 z-50">
      <div className="h-full w-full mx-auto inline-flex items-center justify-between gap-1 md:gap-3 px-4">
        ...
        {/* delivery */}
        <div className={`${isOpen ? 'block' : 'hidden'} lg:flex px-2 border border-transparent hover:border-white cursor-pointer duration-300 items-center justify-center h-[70%] gap-1`}>
          <SlLocationPin />
                ...
                <>
                 {searchQuery && filteredProducts.map((item: StoreProduct) => (
                    <Link
                      ...
                      href={`/product/${item._id}`} // Assuming you have a dynamic route for products
        ...
        <div className={`${isOpen ? 'block' : 'hidden'} lg:flex`}>
          {userInfo ? (
            ...
            <div
              onClick={() => signIn()}
              className="text-xs text-gray-100 flex-col justify-center px-2 border border-transparent hover:border-white cursor-pointer duration-300 h-[70%]"
            >
              <p>Hello, sign in</p>
        ...
        <Link
          href={"/favorite"}
          className="text-xs text-gray-100 flex-col justify-center px-2 border border-transparent hover:border-white cursor-pointer duration-300 h-[70%] relative"
        >
          <p>Marked</p>
