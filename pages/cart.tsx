...
const CartPage = () => {
 ...
 return (
    <div className='max-w-screen-2x1 mx-auto px-6 grid grid-cols-1 sm:grid-cols-5 gap-10 py-4'>
      ...
      <>
        <div className='bg-white col-span-full sm:col-span-4 p-4 rounded-lg'>
          ...
          <div className='bg-white h-64 col-span-full sm:col-span-1 p-4 rounded-lg flex items-center justify-center'>
            <CartPayment />
          </div>
        </>
      ):(
